...
describe("Application", () => {
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    // 9. Wait until the element with the text "Could not create appointment" is displayed.
    await waitForElement(() => getByText(appointment, "Could not create appointment"));
    
    // 10. Check that the appointment has the text "Could not create appointment".
  ...
  it("shows the delete error when failing to delete an existing appointment", async () => {
    ...
    // 8. Wait until the element with the text "Could not create appointment" is displayed.
    await waitForElement(() => getByText(appointment, "Could not close appointment"));
    
     // 10. Check that the appointment has the text "Could not close appointment".
     expect(getByText(appointment, "Could not close appointment")).toBeInTheDocument();
  });
})
